...
def create_dict(dataset, list_save_dir, jpg_png_save_dir):
    train_dir = os.path.join(jpg_png_save_dir, 'nyu2_train')
    ...
    for subset in subset_list:
        ...
        print(subset_source_dir)
        rgb_list = glob(subset_source_dir + '/*.jpg')
        depth_list = glob(subset_source_dir + '/*.png')

        rgb_list.sort(key=natural_keys)
